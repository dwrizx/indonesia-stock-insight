  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between text-[10px] text-muted-foreground px-1">
        <span>
          Sumber indeks: {source === "yahoo-live" ? "Yahoo Live" : "Snapshot"}
        </span>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div
                    className={`flex items-center gap-1 rounded-md px-1.5 py-0.5 text-[10px] font-bold ${isGain ? "bg-gain/10 text-gain" : "bg-loss/10 text-loss"}`}
                  >
                    {isGain ? (
                ...
                <p className="font-mono text-xl font-extrabold text-foreground mb-2">
                ...
                <div className="mt-2 h-1 rounded-full bg-secondary/50 overflow-hidden">
                  <motion.div
                    initial={{ width: 0 }}
                    animate={{
                      width: `${Math.min(50 + Math.abs(idx.changePercent) * 20, 95)}%`,
                    }}
                ...
                <p
                  className={`mt-2 font-mono text-xs font-semibold ${isGain ? "text-gain" : "text-loss"}`}
                >
                  {isGain ? "+" : ""}
